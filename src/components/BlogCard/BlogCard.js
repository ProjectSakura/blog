import { Body, BodyInner, Heading, SubHeading, ImgDiv, Image, Description, UnorderedList, ListItem, AuthorSec, AuthorHead, AuthorSubHead } from "./styles";
function BlogCard() {
    return (
        <Body>
            <BodyInner>
                ...
                <Description>
                    ...
                    It's quite pressurizing psychologically. But even then we are doing what we love and bringing another update of ProjectSakura. So, Let's take "ProjectSakura to the mooooooooon".
                <br></br>
                ...
                <UnorderedList>
                    ...
                    <br></br>
                    <ListItem>Trebuchet now look and feel like Pixel Launcher with a search bar in dock. And YES, it can be toggled
                Applock can now lock apps Instantly after exiting</ListItem>
                    <br></br>
