...
function AndroidBetaTwo() {
  const url = "https://direwolf-tech.disqus.com/3.R-android-11-beta-2";
  const identifier = "Android Beta Two";
  const title = "Project Sakura | Android Beta Two";
  useEffect(() => {
    document.title = "Project Sakura | Android Beta Two";
  }, []);
  return (
    <Body>
      <Navbar />
