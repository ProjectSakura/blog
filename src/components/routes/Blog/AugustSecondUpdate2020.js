...
function AugustSecondUpdate2020() {
  ...
  const url = "https://direwolf-tech.disqus.com/second-update-of-august-2020";
  const identifier = "August Second Update 2020";
  const title = "Project Sakura | August Second Update 2020";
  useEffect(() => {
    //preloading image
    const img = new Image();
    img.onload = () => {
