...
function SecondUpdateOfJune2020() {
  ...
  const url = "https://direwolf-tech.disqus.com/second-update-of-june-2020";
  const identifier = "Second UpdateOf June";
  const title = "Project Sakura | Second UpdateOf June";
  useEffect(() => {
